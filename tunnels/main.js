 ...
 */
(function() {
  var b, box, box_geo, camera, camera_uses_path, clicked, cone, cone_geo, cone_mat, controls, counter, crosshairs, ctrls, d, debug_mat, degToRad, extrudeSettings, eye_point, eye_pos, eye_target, eye_val, fire, flat_mat, getBoxMat, getBoxWireMat, hideInfoPanel, info_panel, is_zapping, lambert_mat, laser, laser_geo, laser_mat, laser_targeter, line, line_e, line_geo, line_mat, line_n, line_s, line_w, log, mouse_pos, num_boxes, num_points, onClick, onKeyUp, onMouseMove, p, panel, point, point_light, points, pos, prob, renderFrame, renderer, scene, showInfoPanel, spline, spline_length, target, toggleFollow, toggleInfoPanel, tube, tube_flat, tube_geo, tube_mats_array, val, win_half_height, win_half_width, wire_mat;
